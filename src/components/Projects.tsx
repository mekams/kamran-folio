  ...
  const projects = [
    {
      ...
      description:
        "Resume Builder web application allows users to enter personal and professional details via structured forms and choose from multiple modern templates. It leverages the tech stack below to generate and download resumes in PDF format.",
    ...
    },
    {
      title: "Youtube Clone",
      description:
        "YouTube Clone delivers a smooth user experience with interactive video search, browsing, and playback, achieving fast load times and high responsiveness. It supports real-time data fetching and responsive design, resulting in increased user engagement and smooth interaction across devices.",
    ...
    },
    {
      title: "Food Delivery",
      description:
        "Food Delivery web app offers an intuitive interface for browsing, customizing, and ordering pizzas with real-time cart updates and order tracking. Efficient state management and routing enable fast, responsive performance across all devices.",
    ...
    },
    {
      ...
      description:
        "LangChain Text Summarization is a hybrid text summarization tool using Hugging Face models and LangChain, improving ROUGE-1 F1 scores by 28% (68.66% vs. 53.52%). Deployed a real-time Streamlit app for document upload, summary generation, and model evaluation using CNN/DailyMail and ROUGE metrics.",
    ...
    },
    {
      ...
      description:
        "Textu is a sleek and simple text utility app designed for fast and effortless text manipulation.It offers features like uppercase, lowercase, capitalise, text-to-speech, copy to clipboard, and delete/clear text.Perfect for quick formatting, editing, or converting text on the go.",
    ...
    },
    {
      ...
      description:
        "The Random Forest model achieved the highest accuracy (96%) and F1-score, making it the most reliable and robust for predicting lung cancer mortality, while ANN showed improvement but remained less accurate, and future work should enhance model interpretability and incorporate more diverse data.x",
    ...
    },
    {
      ...
      description:
        "Integrated Project Management System is a relational database solution designed using MySQL with 13+ normalized entities, reducing redundancy by 30%. It includes over 12 complex SQL queries to extract critical business insights such as top-spending customers and project tracking.",
          ...
          const CardContent = (
            <div
              className={`group bg-gray-800/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-700/50 hover:border-emerald-500/70 transition-all duration-300 shadow-lg hover:shadow-2xl flex flex-col h-full hover:bg-emerald-900/30
                ${
                  hasDemo
                    ? "cursor-pointer hover:-translate-y-2 hover:scale-[1.025] hover:bg-emerald-900/30"
            ...
            >
              ...
              <div className="p-4 flex flex-col justify-center flex-1">
                <div className="flex items-center justify-between mb-1">
                  <h3 className="text-lg font-bold text-white group-hover:text-white transition-colors duration-300 truncate">
                    {project.title}
                  </h3>
                  <a
